class Drawflow {
  ...
  addNode(
    ...
    if (typenode === false) {
      ...
      let clonedNode = html.cloneNode(true);
      this.removeAttributes(clonedNode);
      this.registerNode(name, clonedNode);
      content.appendChild(this.noderegister[name].html);
    } else {
    ...
    Object.entries(data).forEach(function (key, value) {
      console.log("addNode on Drop data Parameter " + { key, value });
  ...
  /* Events */
  on(event, callback) {
    console.log("on Events " + { event, callback });
